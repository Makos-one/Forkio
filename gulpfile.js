...
function moveJs() {
  return gulp.src("./src/**/*.js").pipe(gulp.dest("./dist/")).pipe(browserSync.stream());
};
...
const build = gulp.series(cleanDist, moveHtml, moveFonts, moveJs, gulp.parallel(buildStyles, buildScripts, optimizeImages));
